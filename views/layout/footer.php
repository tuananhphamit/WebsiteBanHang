                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <p>Chúng tôi có đội ngũ chất lượng cao phục vụ 24/24</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        ...
                                        <li><i class="pe-7s-mail"></i> <a href="mailto:demo@plazathemes.com">20212101@eaut.edu.vn</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2024 <b>Website bán đồ thể thao cho Công ty TNHH May Mặc An Thắng
                            </b> Được tạo  <i class="fa fa-heart text-danger"></i> bởi <b>DEV</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
